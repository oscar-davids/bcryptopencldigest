#include "./in_vendor.cl"
#include "./in_constants.h"
#include "./in_functions.cl"
#include "./in_types.cl"
...
/*
__kernel void bcrypt (__global pw_t *pws, __global bcrypt_tmp_t *tmps, __global const u32 *salt_buf, __global u32 *loop_cnt, __global u32* R)
{
    ...
    for (u32 i = 0; i < 256; i++)  // init S_BOX
    {
        S0[i] = c_sbox0[i];
        S1[i] = c_sbox1[i];
        S2[i] = c_sbox2[i];
...
__kernel void mybcrypt(__global pw_t *pws, __global u32 *salt_buf, __global u32 *loop_cnt, __global u32 *R)
{
    const u32 pw_len = pws[0].pw_len;
